...
//@SuppressLint("RecyclerView") add because of error showing    @SuppressLint("RecyclerView")
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position , @NonNull MainModel model) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText product = view.findViewById(R.id.textProduct);
                EditText email = view.findViewById(R.id.textEmail);
                EditText phone = view.findViewById(R.id.textPhone);
                EditText surl = view.findViewById(R.id.textURL);
